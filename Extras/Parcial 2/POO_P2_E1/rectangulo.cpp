...
void Rectangulo::setX(int x) { this->x = x; }
void Rectangulo::setY(int y) { this->y = y; }
void Rectangulo::setAncho(int ancho) { this->ancho = ancho; }
void Rectangulo::setAlto(int alto) { this->alto = alto; }
